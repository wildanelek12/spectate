...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="header-text">
                        <h1 style="font-family: 'Monoton', cursive; ">SPECTATE 2022</h2>
                            <p>Mahakarya Pertunjukan dari mahasiswa Fakultas Teknik UM dari berbagai aspek akademik
    ...
    <div class="categories-collections" id="ticket">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section-heading">
                                    ...
                                    <h2>Pilih Tipe Tiketmu <em>Sekarang</em></h2>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="owl-collection owl-carousel">
                                    <div class="item">
                                        ...
                                        <div class="down-content">
                                            ...
                                            <span class="collection">Prize<br><strong>Rp.26,000</strong></span>
                                            <div class="main-button">
                                                <a href="explore.html">Add To Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="item">
                        ...
                        <p>If you would like to support our TemplateMo website, please visit <a rel="nofollow"
                            ...
                            PayPal contribution. Thank you.</p>
                    </div>
                </div>
            </div>
        </div>
