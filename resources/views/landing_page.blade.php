...
<head>
  ...
  <!-- CSS Files -->
  <link href="{{assets()../assets/}}css/blk-design-system.css?v=1.0.0" rel="stylesheet" />
...
<body class="landing-page">
  ...
  <div class="wrapper">
    <div class="page-header">
      <img src="{{assets()../assets/}}img/blob.png" class="path">
      <img src="{{assets()../assets/}}img/path2.png" class="path2">
      <img src="{{assets()../assets/}}img/triunghiuri.png" class="shapes triangle">
      <img src="{{assets()../assets/}}img/waves.png" class="shapes wave">
      <img src="{{assets()../assets/}}img/patrat.png" class="shapes squares">
      <img src="{{assets()../assets/}}img/cercuri.png" class="shapes circle">
      <div class="content-center">
        <div class="row row-grid justify-content-between align-items-center text-left">
          ...
          <div class="col-lg-4 col-md-5">
            <img src="{{assets()../assets/}}img/etherum.png" alt="Circle image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
    <section class="section section-lg">
      <section class="section">
        <img src="{{assets()../assets/}}img/path4.png" class="path">
        <div class="container">
    ...
    <section class="section section-lg">
      <img src="{{assets()../assets/}}img/path4.png" class="path">
      <img src="{{assets()../assets/}}img/path5.png" class="path2">
      <img src="{{assets()../assets/}}img/path2.png" class="path3">
      <div class="container">
    ...
    <section class="section section-lg section-safe">
      <img src="{{assets()../assets/}}img/path5.png" class="path">
      <div class="container">
        <div class="row row-grid justify-content-between">
          <div class="col-md-5">
            <img src="{{assets()../assets/}}img/chester-wade.jpg" class="img-fluid floating">
    ...
    <section class="section section-lg section-coins">
      <img src="{{assets()../assets/}}img/path3.png" class="path">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <hr class="line-info">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card card-coin card-plain">
              <div class="card-header">
                <img src="{{assets()../assets/}}img/bitcoin.png" class="img-center img-fluid">
              </div>
              <div class="card-body">
                <div class="row">
          ...
          <div class="col-md-4">
            <div class="card card-coin card-plain">
              <div class="card-header">
                <img src="{{assets()../assets/}}img/etherum.png" class="img-center img-fluid">
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12 text-center">
          ...
          <div class="col-md-4">
            <div class="card card-coin card-plain">
              <div class="card-header">
                <img src="{{assets()../assets/}}img/ripp.png" class="img-center img-fluid">
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12 text-center">
  ...
  <!--   Core JS Files   -->
  <script src="{{assets()../assets/}}js/core/jquery.min.js" type="text/javascript"></script>
  <script src="{{assets()../assets/}}js/core/popper.min.js" type="text/javascript"></script>
  ...
  <script src="{{assets()../assets/}}js/plugins/bootstrap-switch.js"></script>
  <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
  <script src="{{assets()../assets/}}js/plugins/nouislider.min.js" type="text/javascript"></script>
  <!-- Chart JS -->
  ...
  <script src="{{assets()../assets/}}js/plugins/bootstrap-datetimepicker.js" type="text/javascript"></script>
  <!-- Black Dashboard DEMO methods, don't include it in your project! -->
  <script src="{{assets()../assets/}}demo/demo.js"></script>
  <!-- Control Center for Black UI Kit: parallax effects, scripts for the example pages etc -->
  <script src="{{assets()../assets/}}js/blk-design-system.min.js?v=1.0.0" type="text/javascript"></script>
  <script>
